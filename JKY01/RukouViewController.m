...
txt36,
txtbeizhu3;
@synthesize lbltingneishoufeidaoji,
txt41,
txt42,
txt43,
txt44,
...
-(Boolean)AddData1
{
    ...
    Boolean add = [cc AddRukouCarCheckWithRoadID:strRoadID TaskID:strTaskID SortID:strSortID CheckPro:strCheckPro Unit:strUnit Num1:Num1 Num2:Num2 Num3:Num3 Num4:Num4 Num5:Num5 Num6:Num6 Remark:strRemark Checked:strChecked Record:strRecord CheckAagin:strCheckAagin CheckDate:strDate AddUser:strAddUser AddDate:strAddDate flg:@"0" Uploadflg:strUploadflg];
    ...
    add = [cc AddRukouCarCheckWithRoadID:strRoadID TaskID:strTaskID SortID:strSortID CheckPro:strCheckPro Unit:strUnit Num1:Num1 Num2:Num2 Num3:Num3 Num4:Num4 Num5:Num5 Num6:Num6 Remark:strRemark Checked:strChecked Record:strRecord CheckAagin:strCheckAagin CheckDate:strDate AddUser:strAddUser AddDate:strAddDate flg:@"0" Uploadflg:strUploadflg];
    ...
    strCheckPro = [self CheckEmpty:lbltingneishoufeidaoji.text];
    strUnit = @"个";
    ...
    strCheckPro = [self CheckEmpty:lblETCkongtiao.text];
    strUnit = @"个";
