...
@interface ChukouViewController : UIViewController
{
    NSString *strRoadID;
    NSString *strTaskID;
    NSString *strSortID;
...
//--------------------------4-----------------------------------------------------------
@property (strong, nonatomic) IBOutlet UILabel *lblchedaoji;
...
//--------------------------20-----------------------------------------------------------
@property (strong, nonatomic) IBOutlet UILabel *lblkongtiao;
...
//--------------------------21-----------------------------------------------------------
@property (strong, nonatomic) IBOutlet UILabel *lblfeier;
...
//--------------------------22-----------------------------------------------------------
@property (strong, nonatomic) IBOutlet UILabel *lblpiaoju;
...
//--------------------------23-----------------------------------------------------------
@property (strong, nonatomic) IBOutlet UILabel *lbljizhongcheng;
...
@property (strong, nonatomic) IBOutlet UITextField *txt251;
@property (strong, nonatomic) IBOutlet UITextField *txt252;
@property (strong, nonatomic) IBOutlet UITextField *txt253;
@property (strong, nonatomic) IBOutlet UITextField *txt254;
@property (strong, nonatomic) IBOutlet UITextField *txt255;
@property (strong, nonatomic) IBOutlet UITextField *txt256;
@property (strong, nonatomic) IBOutlet UITextField *txtbeizhu25;


//--------------------------26-----------------------------------------------------------
@property (strong, nonatomic) IBOutlet UILabel *lblETCshoufei;
@property (strong, nonatomic) IBOutlet UITextField *txt261;
@property (strong, nonatomic) IBOutlet UITextField *txt262;
@property (strong, nonatomic) IBOutlet UITextField *txt263;
@property (strong, nonatomic) IBOutlet UITextField *txt264;
@property (strong, nonatomic) IBOutlet UITextField *txt265;
@property (strong, nonatomic) IBOutlet UITextField *txt266;
@property (strong, nonatomic) IBOutlet UITextField *txtbeizhu26;


//--------------------------27-----------------------------------------------------------
@property (strong, nonatomic) IBOutlet UILabel *lblbianxieshoufei;
@property (strong, nonatomic) IBOutlet UITextField *txt271;
@property (strong, nonatomic) IBOutlet UITextField *txt272;
@property (strong, nonatomic) IBOutlet UITextField *txt273;
@property (strong, nonatomic) IBOutlet UITextField *txt274;
@property (strong, nonatomic) IBOutlet UITextField *txt275;
@property (strong, nonatomic) IBOutlet UITextField *txt276;
