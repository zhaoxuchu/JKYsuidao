...
@property (nonatomic, strong) UITextField *alertTxtName;
@property (nonatomic, strong) UITextField *alertTxtPsd;
   ...
   rightButtonTitle:(NSString *)rigthTitle
{
    if (self = [super init]) {
        ...
        CGFloat txtNameWidth = kAlertWidth - 16;
        self.alertTxtName = [[UITextField alloc] initWithFrame:CGRectMake((kAlertWidth - txtNameWidth) * 0.5, 35, txtNameWidth, 30)];
        ...
        CGFloat txtpsdWidth = kAlertWidth - 16;
        self.alertTxtPsd = [[UITextField alloc] initWithFrame:CGRectMake((kAlertWidth - txtpsdWidth) * 0.5, 75, txtpsdWidth, 30)];
